...
def update():
    ...
    latestCommit = get('https://raw.githubusercontent.com//reconspider/master/core/update_log.py').text
    ...
    if changes not in latestCommit:  # just a hack to see if a new version is available
        ...
        if choice == 'y':
            ...
            os.system('git clone --quiet https://github.com//reconspider %s' % (folder))
